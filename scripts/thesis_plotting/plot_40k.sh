python scripts/data_display/plot_pareto.py \
    result_csvs/dec7results/s100_pareto_*.csv \
    result_csvs/dec7results/bco_pareto_* \
    result_csvs/dec7results/neural_bco_pareto_* \
    result_csvs/dec7results/s40k_pareto_* --labels \
    -o ../thesis_latex/figs/ch4/pareto_plots/40k.pdf
python scripts/data_display/hypervolume.py \
    result_csvs/dec7results/s100_pareto_*csv \
    result_csvs/dec7results/bco_pareto_* \
    result_csvs/dec7results/neural_bco_pareto_* \
    result_csvs/dec7results/s40k_pareto_* \
